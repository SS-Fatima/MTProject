...
class StandardProperties:
    ...
    SPEED_OF_SOUND_AIR = 1540
    SPEED_OF_SOUND_MUSCLE = 1540
    SPEED_OF_SOUND_BONE = 1540     # Cortical bone
    SPEED_OF_SOUND_BLOOD = 1540
    SPEED_OF_SOUND_SKIN = 1540
    SPEED_OF_SOUND_FAT = 1540
    SPEED_OF_SOUND_GEL_PAD = 1540
    SPEED_OF_SOUND_WATER = 1540
    SPEED_OF_SOUND_HEAVY_WATER = 1540
    SPEED_OF_SOUND_LYMPH_NODE = 1540
